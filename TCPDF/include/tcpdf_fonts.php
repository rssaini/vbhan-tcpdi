...
class TCPDF_FONTS {
	...
	public static function _getfontpath() {
		if (!defined('VBHAN_K_PATH_FONTS') AND is_dir($fdir = realpath(dirname(__FILE__).'/../fonts'))) {
			if (substr($fdir, -1) != '/') {
				$fdir .= '/';
			}
			define('VBHAN_K_PATH_FONTS', $fdir);
		}
		return defined('VBHAN_K_PATH_FONTS') ? VBHAN_K_PATH_FONTS : '';
	}
