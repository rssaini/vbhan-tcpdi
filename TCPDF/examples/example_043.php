...
$pdf = new TCPDF(VBHAN_PDF_PAGE_ORIENTATION, VBHAN_PDF_UNIT, VBHAN_PDF_PAGE_FORMAT, true, 'UTF-8', true);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, VBHAN_PDF_HEADER_LOGO_WIDTH, VBHAN_PDF_HEADER_TITLE.' 043', VBHAN_PDF_HEADER_STRING);
