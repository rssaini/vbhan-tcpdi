...
$pdf->SetHeaderData(PDF_HEADER_LOGO, VBHAN_PDF_HEADER_LOGO_WIDTH, VBHAN_PDF_HEADER_TITLE.' 016', VBHAN_PDF_HEADER_STRING);

// set header and footer fonts
$pdf->setHeaderFont(Array('helvetica', '', VBHAN_PDF_FONT_SIZE_MAIN));
$pdf->setFooterFont(Array('helvetica', '', VBHAN_PDF_FONT_SIZE_DATA));
