...
class MYPDF extends TCPDF {
	...
	public function Header() {
		// Logo
		$image_file = VBHAN_K_PATH_IMAGES.'logo_example.jpg';
...
$pdf = new MYPDF(VBHAN_PDF_PAGE_ORIENTATION, VBHAN_PDF_UNIT, VBHAN_PDF_PAGE_FORMAT, true, 'UTF-8', false);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, VBHAN_PDF_HEADER_LOGO_WIDTH, VBHAN_PDF_HEADER_TITLE, VBHAN_PDF_HEADER_STRING);
...
$pdf->SetDefaultMonospacedFont(VBHAN);
